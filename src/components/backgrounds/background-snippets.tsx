...
const BgTheme10 = () => {
  return (
    <div className="absolute z-[-10]  size-full  bg-white">
      <div className="absolute size-full bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)]"></div>
    </div>
  );
};
const BgTheme11 = () => {
  return (
    <div className="absolute inset-0  z-[-10] size-full  bg-white bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]"></div>
  );
};

const BgTheme12 = () => {
  return (
    <div className="absolute inset-0 z-[-10] size-full  bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]"></div>
  );
};

const BgTheme4 = () => {
  return (
    <div className="absolute top-0 z-[-10] size-full bg-white bg-[radial-gradient(100%_50%_at_50%_0%,rgba(0,163,255,0.13)_0,rgba(0,163,255,0)_50%,rgba(0,163,255,0)_100%)]"></div>
  );
};
...
const BgTheme6 = () => {
  return (
    <div className="absolute inset-0 z-[-10] size-full  bg-white [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#63e_100%)]"></div>
  );
};
